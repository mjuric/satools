...
c  survey case;
 ...
 101     format(i4,a2)
         ...
         elseif(cd.eq.'T3')then
            ...
            write(*,*)' unknown survey ',nam
         endif
      endif
      return
 99   write(*,*)' encoding error ',nam
      icode=0
      end
c =======================================================
c  {\bf codnam}
...
c  names with year
 ...
 103        format(i2,a1,a1,i2)
            ...
            write(*,*)' problems with identifyer ', icode
         endif
...
c 107        format(i2)
c         else
c            write(*,*)' problems with year in ',icode
c         endif
      endif
      return
      end
