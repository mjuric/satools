...
c compute C1^55,C2^55
       ...
       write(99,*)aval15(1),aval15(5)/aval15(1)
       do i=1,5
         do j=1,5
             gamma55(i,j)=g2(i,j)
         enddo
       ...
       write(99,*)aval25(1),aval25(5)/aval25(1)
c now take mean 
...
c  if invertible, computation of the inverse of c0
          ...
          if(detc0.lt.0.d0)then
             write(9,109) detc0,nam1,nam2
 109         format('detc0 non positive ',f12.3,1x,a6,1x,a6)
          endif
          g0(1,1)=c0(2,2)/detc0
          g0(2,2)=c0(1,1)/detc0         
          g0(1,2)=-c0(2,1)/detc0
...
c             write(99,*)'deltaq not consistent',ddel,nam1,nam2
c          endif
      return
      end
c ===================================================
...
c ***********************************
     ...
     +          ((eq1(1)-eq2(1))/(eq1(1)+eq2(1)))**2
         ...
         write(99,*) 'Error in dimension num'
         stop
      endif
      return
      end
