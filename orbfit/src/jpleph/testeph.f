...
C      Write a fingerprint to the screen.                                       
       ...
       write(99,*) ' JPL TEST-EPHEMERIS program. ' //                            
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      IF ( MOD(LINE,npt) .EQ. 0 )  write(99,200)                                 
...
C        CALL FSIZER3(NRECL,KSIZE,NRFILE,NAMFIL)                                
      ...
      IF(NRECL .EQ. 0) write(99,*)'  ***** FSIZER IS NOT WORKING *****'          
...
C       GET LIBRATIONS IF REQUESTED (AND IF ON FILE)                            
  ...
  98  write(99,198)ET2(1)+ET2(2),SS(1),SS(2)                                     
 198  format(' ***  Requested JED,',f12.2,                                      
     * ' not within ephemeris limits,',2f12.2,'  ***')                          
                                                                                
      stop                                                                      
                                                                                
   99 write(99,'(2F12.2,A80)')ET2,'ERROR RETURN IN STATE'                        
