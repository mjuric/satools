...
c Object Name
      ...
      if(mpcname1.ne.mpcname2)then
         write(99,*)'name error radar obs. ',mpcname1,' ',mpcname2
         errcod=44
         goto 10
      endif
...
c ========== HANDLE DATE AND TIME =================
 ...
 100  FORMAT(15X,I4,1X,I2,1X,A9)
      ...
      if(year.ne.year2.or.month.ne.month2.or.chdate.ne.chdate2)then
         write(99,*)'date error radar obs. ',year,' ',month,' ',chdate
         write(99,*)'                      ',year2,' ',month2,' ',chdate2
         errcod=45
         goto 10
      endif
      ll=lench(chdate)
...
* Position of the decimal point
      pp=INDEX(chdate,'.')
      IF(pp.EQ.0) THEN
          write(99,*)'mpcrad: radar data without correct time'
          STOP
c          errcod=2
