...
*
      ...
      IF(multi .AND. (ll.GT.0)) THEN
          ...
          IF(stdout) write(99,133) b(1:w),label(1:ll)
      END IF
 ...
 133  FORMAT(A,'Orbital elements for ',A,':')
      ...
      IF(multi) THEN
          ...
          IF(stdout) write(99,110) b(1:w),t0,cm,day,year,hour
      END IF
