...
c radmpc determines whether MPC radar observations are used or ignored.
         if(radmpc)then
            write(99,*)'Radar observation near record ',nobs
...
c  generate range and range rate only if mixed observation
            ...
            if(rec1(15:15).eq.'R')write(99,*) 'ignoring MPC radar obs'
            nobs=nobs-1
            goto 1
         endif
c ================= HANDLE SATELLITE ============================
      elseif(rec1(15:15).eq.'S'.or.rec1(15:15).eq.'s')then
         write(99,*)'Satellite observation at record ',nobs
         nobs=nobs-1
c         iobs(nobs)=3000+j
         goto 1
c ================= HANDLE OPTICAL ============================
...
c erroneous radar ending
 20   write(99,*) 'mpcin: incomplete radar observation, end of file'
      stop
      end
