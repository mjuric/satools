...
c =====================================================================
      if(iob1/1000.eq.2.and.inl.eq.2)then
         write(99,*)' preobn: mixing of radar and two-body '//
...
c     write(99,*)'preobn calls alfdel', t0,t1
     ...
     +        daddet(1,2),1,twobo)
      ELSE
         write(99,*)' preobn: this observation type not supported ',iob1
         RETURN           
      ENDIF
...
c temporary output
        if(iob1/1000.eq.1)then
           write(99,*)n,', RA/DEC (deg)',al(n)*degrad,de(n)*degrad,ng
        elseif(iob1/1000.eq.2)then
           write(99,*)n,', R/RDOT (km,km/day)',al(n)*au,de(n)*au,ng
        endif
 7    continue
c =====================================================================
