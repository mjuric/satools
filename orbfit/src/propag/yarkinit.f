...
c - projections s_P and s_Q of the spin axis computed
     ...
     .         dcos(elkep(3))*dcos(elkep(4))*dcos(elkep(5))
         ...
         write(99,*)' Obliquity of the spin axis; Yarkovsky: ',obli
...
c close the input file
         call filclo(unit,' ')
      ELSE
         write(99,*)' Yarkovsky datafile not found:',file(1:le)
         stop     
      ENDIF
      write(99,*)' Yarkovsky data loaded for asteroid ', astnam
      RETURN
 111  yarfil=.false.
      write(99,*)' incomplete yarkovsky file for asteroid ', astnam
      RETURN
      END
